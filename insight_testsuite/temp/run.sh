...
# use the following command if you want to use main_parse.py
#python ./src/main_parse.py ./input/itcont.txt ./output/medianvals_by_zip.txt ./output/medianvals_by_date.txt
# use the following command if you want to use main_parse_multiprocess.py, which is a multi process version of main_parse.py
